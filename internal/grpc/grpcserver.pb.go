...
const file_grpcserver_proto_rawDesc = "" +
	"\n" +
	"\x10grpcserver.proto\x12\x05proto\"\x1e\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	...
	"\adeleted\x18\x01 \x01(\bR\adeleted2\xa7\x01\n" +
	"\fStoreService\x12.\n" +
	...
	"\x06Delete\x12\x14.proto.DeleteRequest\x1a\x15.proto.DeleteResponse\"\x00B9Z7github.com/p4trickweiss/distributed-cache/internal/grpcb\x06proto3"

var (
	file_grpcserver_proto_rawDescOnce sync.Once
	file_grpcserver_proto_rawDescData []byte
)

func file_grpcserver_proto_rawDescGZIP() []byte {
	file_grpcserver_proto_rawDescOnce.Do(func() {
		file_grpcserver_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grpcserver_proto_rawDesc), len(file_grpcserver_proto_rawDesc)))
	})
	return file_grpcserver_proto_rawDescData
}

var file_grpcserver_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_grpcserver_proto_goTypes = []any{
...
var file_grpcserver_proto_depIdxs = []int32{
	0, // 0: proto.StoreService.Get:input_type -> proto.GetRequest
	2, // 1: proto.StoreService.Set:input_type -> proto.SetRequest
	4, // 2: proto.StoreService.Delete:input_type -> proto.DeleteRequest
	1, // 3: proto.StoreService.Get:output_type -> proto.GetResponse
	3, // 4: proto.StoreService.Set:output_type -> proto.SetResponse
	5, // 5: proto.StoreService.Delete:output_type -> proto.DeleteResponse
...
func file_grpcserver_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_grpcserver_proto_rawDesc), len(file_grpcserver_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
