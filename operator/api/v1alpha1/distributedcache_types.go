...
type DistributedCacheSpec struct {
	...
	// foo is an example field of DistributedCache. Edit distributedcache_types.go to remove/update
	// +optional
...
type DistributedCacheStatus struct {
	...
	// conditions represent the current state of the DistributedCache resource.
